...
public class WechatController {
   ...
   * 开发过程中步骤如下：
   * * <ol>
   * *   <li>注册https://mp.weixin.qq.com/debug/cgi-bin/sandboxinfo?action=showinfo&t=sandbox/index</li>
   * *   <li>本地启用frpc，服务端wechat.mengyunzhi.com启用frps</li>
   * *   <li>frpc的配置信息请联系项目负责人</li>
   * * </ol>
   * </p>
   * 微信官方说明(不能叫文档，因为太烂了)：https://developers.weixin.qq.com/doc/offiaccount/Basic_Information/Access_Overview.html
   *
